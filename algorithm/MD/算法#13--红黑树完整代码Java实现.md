...
红黑树（英语：Red–black tree）是一种**自平衡二叉查找树**，是在计算机科学中用到的一种数据结构，典型的用途是实现关联数组。
...
![](http://i.imgur.com/wLS6wDB.jpg)

## 旋转 ##

旋转又分为**左旋和右旋**。通常左旋操作用于将一个向右倾斜的红色链接旋转为向左链接。对比操作前后，可以看出，该操作实际上是将红线链接的两个节点中的一个较大的节点移动到根节点上。

左旋操作如下图：

![](http://i.imgur.com/68wSlX9.gif)

右旋旋操作如下图：

![](http://i.imgur.com/DnnMMud.gif)

即：

![](http://i.imgur.com/fSDsoUj.jpg)

颜色反转

当出现一个临时的4-node的时候，即一个节点的两个子节点均为红色，如下图。这其实是个A，E，S 4-node连接，我们需要将E提升至父节点，操作方法很简单，就是把E对子节点的连线设置为黑色，自己的颜色设置为红色。

![](http://i.imgur.com/reTNR2O.jpg)
...
![](http://i.imgur.com/LLM2cXX.jpg)

# Java代码 #

[点击下载代码](https://github.com/tclxspy/Articles/blob/master/algorithm/Code/RedBlackBST.java)
